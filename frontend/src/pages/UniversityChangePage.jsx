...
const processSteps = [
  ...
  },
  {
    ...
    description: "Seamless visa updates and enrollment support at your new university",
    icon: GraduationCap,
  },
];
...
const services = [
  ...
  },
  {
    ...
    description: "Complete support for student visa updates during your university transition",
    benefits: ["Legal compliance", "No visa issues", "Smooth transition"],
    color: "emerald",
  },
  {
    icon: Briefcase,
...
const BERLIN_PHONE = "+49 1577 4493633";
const WHATSAPP_NUMBER = "4915774493633";
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-50 text-emerald-700 rounded-full text-sm mb-6 border border-emerald-100">
                ...
                <span className="font-medium">Berlin University Transfer Experts</span>
              </div>
            ...
            {/* Right - Form */}
            <div ref={formRef} className="w-full max-w-md mx-auto lg:mx-0 lg:ml-auto">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative overflow-hidden">
            <div className="flex gap-12 md:gap-16 animate-scroll items-center">
              {[...germanUniversities, ...germanUniversities].map((uni, index) => (
                <div 
                  key={index} 
                  className="flex-shrink-0 w-[120px] md:w-[150px] h-[70px] md:h-[90px] flex items-center justify-center"
                  title={uni.name}
                >
                  {imageErrors[index % germanUniversities.length] ? (
                    ...
                    <img 
                      ...
                      onError={() => handleImageError(index % germanUniversities.length)}
                    />
                  )}
                </div>
              ))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              We've simplified the university transfer process into 5 easy steps
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {testimonials.map((testimonial, index) => (
              <TestimonialCard key={index} testimonial={testimonial} isActive={index === activeTestimonial} />
            ))}
          </div>
        </div>
      </section>
      ...
      <section className="py-20 lg:py-28 bg-gradient-to-br from-emerald-600 via-emerald-700 to-teal-700 text-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/20 backdrop-blur rounded-full text-sm mb-6">
            <img src={LOGO_URL} alt="" className="h-4 w-auto brightness-0 invert" />
