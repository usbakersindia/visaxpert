...
const destinations = [
  ...
  { name: "Rest of Europe", image: IMAGES.france },
];
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-12">
        ...
        <div className="relative overflow-hidden">
          <div className="flex gap-12 md:gap-16 animate-scroll items-center">
            {[...allPartnerUniversities, ...allPartnerUniversities].map((uni, index) => {
              const hasError = imageErrors[index % allPartnerUniversities.length];
              return (
                <div
                  key={index}
                ...
                >
                  {hasError ? (
                    ...
                    <img 
                      ...
                      onError={() => handleImageError(index % allPartnerUniversities.length)}
                    />
                  )}
                </div>
              );
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-12">
          <div className="flex items-center justify-between h-16 md:h-20">
            <a href="/" data-testid="logo-link">
              <img src={LOGO_URL} alt="VisaXpert" className="h-14 md:h-16 object-contain" />
            </a>
            <a
              href={`tel:${MAIN_PHONE}`}
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-12">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="relative aspect-video rounded-2xl overflow-hidden shadow-2xl bg-slate-900">
              {/* Placeholder for video - Replace VIDEO_URL with actual YouTube/Vimeo embed or HTML5 video */}
              <div 
                className="absolute inset-0 flex flex-col items-center justify-center bg-gradient-to-br from-[#0F172A] to-[#1E293B]"
                data-testid="video-placeholder"
              >
                <div className="w-20 h-20 bg-[#2563EB] rounded-full flex items-center justify-center mb-6 cursor-pointer hover:bg-[#1D4ED8] transition-colors group">
                  <Play size={32} className="text-white ml-1 group-hover:scale-110 transition-transform" fill="white" />
                </div>
                <p className="text-white/80 text-lg font-medium mb-2">CEO's Message</p>
                <p className="text-white/50 text-sm">Video coming soon</p>
              </div>
              
              {/* Uncomment below for YouTube embed - replace VIDEO_ID with actual ID */}
              {/* 
              <iframe
              ...
              */}
              ...
              {/* Uncomment below for HTML5 video - replace with actual video path */}
              {/*
              <video
                controls
              ...
              >
                <source src="/assets/founder-message.mp4" type="video/mp4" />
