...
const eventSchedule = [
  {
    ...
    date: "20th May 2026",
    day: "Tuesday",
    targetDate: "2026-05-20T10:00:00",
  ...
  },
  {
    ...
    date: "21st May 2026",
    day: "Wednesday",
    targetDate: "2026-05-21T10:00:00",
  ...
  },
  {
    ...
    date: "22nd May 2026",
    day: "Thursday",
    targetDate: "2026-05-22T10:00:00",
  ...
  },
  {
    ...
    date: "23rd May 2026",
    day: "Friday",
    targetDate: "2026-05-23T10:00:00",
              ...
              {[...universities, ...universities].map((uni, index) => (
                <div key={index} className="flex-shrink-0 w-[130px] md:w-[160px] h-[80px] md:h-[100px] flex items-center justify-center" title={uni.name} data-testid={`fair-uni-${index}`}>
                  {imageErrors[index % universities.length] ? (
                    ...
                    <img src={uni.logo} alt={uni.name} className="max-w-full max-h-full object-contain grayscale hover:grayscale-0 transition-all duration-300" onError={() => handleImageError(index % universities.length)} />
                  )}
                </div>
              ))}
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="relative aspect-video rounded-2xl overflow-hidden shadow-2xl bg-slate-900">
              <div className="absolute inset-0 flex flex-col items-center justify-center bg-gradient-to-br from-[#0F172A] to-[#1E293B]" data-testid="fair-video-placeholder">
                <div className="w-20 h-20 bg-gradient-to-br from-amber-500 to-orange-500 rounded-full flex items-center justify-center mb-6 cursor-pointer hover:scale-110 transition-transform shadow-2xl shadow-amber-500/30">
              ...
              <iframe src="https://www.youtube.com/embed/VIDEO_ID" title="Germany Education Fair 2026" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen className="absolute inset-0 w-full h-full"></iframe>
              */}
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-slate-400">
                {eventSchedule.map((event, i) => (
                  <li key={i} className="flex items-center gap-2"><MapPin size={14} className="text-amber-500" />{event.city} — {event.date}</li>
                ))}
              </ul>
            </div>
            <div>
